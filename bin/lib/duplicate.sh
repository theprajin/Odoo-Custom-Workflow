...
print_help()
{
	...
	printf 'Usage: %s [-h|--help] <original-database> <duplicate-database>\n' "$0"
	printf '\t%s\n' "<original-database>: Original Database"
	printf '\t%s\n' "<duplicate-database>: New Database"
	printf '\t%s\n' "-h, --help: Prints help"
}
...
{
	local _required_args_string="'original-database' and 'duplicate-database'"
...
assign_positional_args()
{
	...
	_positional_names="_arg_original_database _arg_duplicate_database "
